		...
		'getUpdateURL': function(data){
			...
			if(typeof data.script_info !== "undefined"){
				if(typeof data.script_info.version !== "undefined")
					args_str += '&scriptversion=' + escape(data.script_info.version);
				
				if(typeof data.script_info.script_handler !== "undefined"){
					args_str += '&scripthandler=' + escape(data.script_info.script_handler);
					if(typeof data.script_info.script_handler_version !== "undefined"){
						args_str += '&scripthandlerversion=' + escape(data.script_info.script_handler_version);
					}
				}
				...
				if(data.script_info.matched_rules.count > 0){
					...
					args_str += '&matchedRules=' + escape(matchedRulesJSON);
				}
