...
(function(MUJS, $){
	...
	*/
	...
	MUJS['ERROR'] = {
		...
		'processError': function(e){
			...
			return MUJS['ERROR']['catchError'](e.message, e.fileName, e.lineNumber, e.columnNumber, data);
		},
	...
	*/
	...
	function checkTimer(){
		...
		if(!MUJSRequire.DOMLoaded || !MUJSRequire.onErrorFunctionAdded || !MUJSRequire.documentComplete){
			BeforeScriptExec();
		} else {
			clearCheckTimer();
		}
